  ...
  return (
    <div className="flex flex-row">
      <div className="wrapper">
        {/* Left Side Section */}
        <div className="lg:flex flex-col gap-y-10 ps-10 hidden" style={{position:'absolute',top:'100px'}}>
          <img
            src={CleanLogo}
        ...
        {/* Right Side Section */}
        <div className="flex flex-col ms-auto bg-white w-[502px] h-[900px] items-center justify-center  z-10 rounded-l-xl gap-y-10">
          <div
